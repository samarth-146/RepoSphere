        ...
        try{
            ...
            if(e.response){
                ...
                if(status==403){
                    ...
                    toast.error('Username already exist', { position: "top-right" });
                }
                else if(status==500){
    ...
    return (
        <div className='maindiv'>
            ...
            <p className="p-4 text-center text-gray-500">
                    ...
                    <Link to="/auth" className="text-blue-500 hover:text-blue-700 font-bold text-sm"> Sign In</Link>
                </p>
            </div>
            <ToastContainer/>
        </div>
